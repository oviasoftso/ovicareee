...
function CustomerProfile() {
  ...
  const removeCondition = (c: string) =>
    setForm({ ...form, chronic_conditions: form.chronic_conditions.filter((x) => x !== c) });
      ...
      <div className="space-y-6">
        ...
        <div className="rounded-xl bg-card border p-6 shadow-card">
          <h3 className="font-display font-semibold mb-4 flex items-center gap-2">
            <AlertTriangle className="h-5 w-5 text-destructive" /> Allergies
          </h3>
        ...
        <div className="rounded-xl bg-card border p-6 shadow-card">
          <h3 className="font-display font-semibold mb-4 flex items-center gap-2">
            <Heart className="h-5 w-5 text-primary" /> Chronic Conditions
          </h3>
          <div className="flex flex-wrap gap-2 mb-3">
