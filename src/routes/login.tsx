    ...
    <div className="min-h-screen grid lg:grid-cols-2">
      <div className="relative hidden lg:flex gradient-hero items-center justify-center p-12 overflow-hidden">
        <div
          ...
          style={{
            backgroundImage:
              "radial-gradient(circle at 30% 20%, oklch(0.76 0.14 180 / 0.3), transparent 50%)",
          }}
        />
        <div className="relative z-10 max-w-md text-white">
          ...
          <p className="mt-6 text-white/70 text-lg">
            Sign in to access your branch, manage prescriptions, run POS and view real-time
            financials.
          </p>
        ...
        <div className="w-full max-w-md">
          ...
          <div className="inline-flex rounded-full bg-muted p-1 mb-8">
            <button
              ...
              className={`flex items-center gap-2 rounded-full px-4 py-2 text-sm font-medium transition ${mode === "staff" ? "bg-card shadow-card text-foreground" : "text-muted-foreground"}`}
            >
              <Stethoscope className="h-4 w-4" /> Staff
            </button>
            <button
              onClick={() => setMode("customer")}
              className={`flex items-center gap-2 rounded-full px-4 py-2 text-sm font-medium transition ${mode === "customer" ? "bg-card shadow-card text-foreground" : "text-muted-foreground"}`}
            >
          ...
          <p className="mt-2 text-muted-foreground">
            Sign in to {mode === "staff" ? "your branch" : "your account"}.
          </p>
          ...
          <form onSubmit={handleSubmit} className="mt-8 space-y-4">
            <div>
              ...
              <input
                ...
                className="mt-1.5 w-full rounded-lg border bg-card px-4 py-3 text-sm outline-none focus:ring-2 focus:ring-primary"
            ...
            <div>
              ...
              <div className="relative mt-1.5">
                <input
                  ...
                  className="w-full rounded-lg border bg-card px-4 py-3 pr-11 text-sm outline-none focus:ring-2 focus:ring-primary"
                  placeholder="••••••••"
                />
                <button
                  type="button"
            ...
            <button
              disabled={submitting}
              className="w-full rounded-lg gradient-primary text-white font-semibold py-3 shadow-glow disabled:opacity-60 flex items-center justify-center gap-2"
            >
          ...
          <div className="mt-8 lg:hidden">
            ...
            <p className="mt-2 text-[10px] text-center text-muted-foreground">
              Tap a role to autofill credentials
            </p>
          </div>

          <p className="mt-12 text-xs text-center text-muted-foreground">
            OviCare v1.0 · Powered by Ovia Software Solutions
          </p>
        </div>
      </div>
    </div>
